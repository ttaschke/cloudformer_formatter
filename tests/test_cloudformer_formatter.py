...
CLOUDFORMER_OUTPUT = {
    ...
    "Resources": {
        "vpcb9bcc3cb": {"Type": "AWS::EC2::VPC", "Properties": {}},
        "vpcb545fcb": {"Type": "AWS::EC2::VPC", "Properties": {}},
        "subnet502ab36f": {
            "Type": "AWS::EC2::Subnet",
            "Properties": {"VpcId": {"Ref": "vpcb9bcc3cb"}},
        },
    },
}
...
EXPECTED_RESULT = {
    ...
    "Resources": {
        ...
        "VPC2": {"Type": "AWS::EC2::VPC", "Properties": {}},
    ...
    def test_main(self, write_output):
        ...
        with p1 as p_open:  # noqa
            with p2 as p_json_load:  # noqa
                cloudformer_formatter.main(
                    ["cloudformer_output", "output_location.json"]
                )
